...
export const s = StyleSheet.create({
  ...
  bubble: { maxWidth: '70%', padding: spacing.s12, borderRadius: radii.bubble },
  bubbleUser: { backgroundColor: colors.accent, borderTopRightRadius: radii.r2 },
  bubbleAI:  { backgroundColor: colors.surface2, borderWidth: 0.5, borderColor: colors.hairline, borderTopLeftRadius: radii.r2 },
