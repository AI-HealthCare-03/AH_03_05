      ...
      <Card shadow>
        ...
        >
          <View style={{ flex: 1, marginRight: spacing.s12 }}>
            ...
            <Text
              style={{
                fontSize: typography.fz13,
                color: drug.manufacturer ? colors.muted : colors.muted2,
                fontStyle: drug.manufacturer ? 'normal' : 'italic',
              }}
            >
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.s6 }}>
            ...
            <Text style={{ fontSize: typography.fz11, color: colors.muted2 }}>
              식품의약품안전처 데이터
            </Text>
          </View>
          {lastFetched && (
